...
export class ResumoComponent implements OnInit {
  resumos: { classe: string, titulo: string, descricao: string, imgSrc: string }[] = [
    { classe: 'res_1', titulo: '20 anos de histórias', imgSrc: 'assets/img/img_26.png',  descricao: 'A sua história faz parte da nossa, e é um prazer fazer parte dela.'},
    ...
    { classe: 'res_3', titulo: 'Genuinamente Brasileira', imgSrc: 'assets/img/img_24.png',  descricao: 'Nascemos em 2004 no interior de Minas Gerais e hoje estamos presentes em 15 estados.'},
    { classe: 'res_4', titulo: 'Clínica especializada em atendimento infantil.', imgSrc: 'assets/img/img_23.png',  descricao: 'Temos orgulho de ser a favorita dos pequeninos. Nossa especialidade em atendimento infantil nos rendeu o prêmio TOP of KIDS em 2023.'},
