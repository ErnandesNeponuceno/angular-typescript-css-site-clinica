...
export class AvaliacaoComponent implements OnInit {
  ...
  avaliacoes: { src: string, nome: string, avaliacao: string }[] = [
    { src: 'assets/img/img_15.jpg', nome: 'Pedro Costa', avaliacao: 'Excelente atendimento! Profissionais muito competentes e atenciosos. Recomendo!' },
    ...
    { src: 'assets/img/img_17.jpg', nome: 'Laura Pereira', avaliacao: 'Ótima experiência! Tratamento eficaz e personalizado. Recomendo a todos!' },
    ...
    { src: 'assets/img/img_14.jpg', nome: 'Tainá Texeira', avaliacao: 'Muito profissionalismo! Recebi um tratamento de alta qualidade e me senti muito bem cuidado. Parabéns à equipe.' }
  ];
